    ...
    describe("collection.import", () => {
        describe("without type", () => {
            ...
            it("should accept buffer of LDJSON arrays", async () => {
                const data = Buffer.from('["_key", "data"]\r\n["tb1", "banana"]\r\n["tb2", "peach"]\r\n["tb3", "apricot"]\r\n');
                const info = await collection.import(data);
                chai_1.expect(info).to.eql({
                    error: false,
                    created: 3,
        ...
        for (const type of ["auto", "documents"]) {
...
//# sourceMappingURL=13-bulk-imports.js.map