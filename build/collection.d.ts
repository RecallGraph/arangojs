 ...
 */
export declare type CollectionImportResult = {
    /**
 ...
 */
export declare type CollectionEdgesResult<T extends object = any> = {
    edges: Edge<T>[];
    stats: {
        scannedIndex: number;
        filtered: number;
 ...
 * replaced with AQL queries.
 */
export declare type SimpleQueryRemoveByExampleResult = {
    /**
 ...
 * replaced with AQL queries.
 */
export declare type SimpleQueryReplaceByExampleResult = {
    /**
 ...
 * replaced with AQL queries.
 */
export declare type SimpleQueryUpdateByExampleResult = {
    /**
     * Number of documents updated.
     */
    updated: number;
 ...
 * replaced with AQL queries.
 */
export declare type SimpleQueryRemoveByKeysResult<T extends object = any> = {
    /**
     * Number of documents removed.
     */
    removed: number;
 ...
 * ```
 */
export interface DocumentCollection<T extends object = any> extends ArangoCollection {
    /**
     ...
     * ```
     */
    figures(): Promise<ArangoResponseMetadata & CollectionMetadata & CollectionProperties & {
        count: number;
        figures: Dict<any>;
    }>;
    /**
     ...
     * ```
     */
    save(data: DocumentData<T>, options?: CollectionInsertOptions): Promise<DocumentMetadata & {
        new?: Document<T>;
    }>;
    /**
     ...
     * ```
     */
    saveAll(data: Array<DocumentData<T>>, options?: CollectionInsertOptions): Promise<Array<DocumentMetadata & {
        new?: Document<T>;
    }>>;
    /**
     ...
     * ```
     */
    replace(selector: DocumentSelector, newData: DocumentData<T>, options?: CollectionReplaceOptions): Promise<DocumentMetadata & {
        new?: Document<T>;
        old?: Document<T>;
    }>;
    /**
     ...
     * ```
     */
    update(selector: DocumentSelector, newData: Patch<DocumentData<T>>, options?: CollectionUpdateOptions): Promise<DocumentMetadata & {
        new?: Document<T>;
        old?: Document<T>;
    }>;
    /**
     ...
     * ```
     */
    replaceByExample(example: Partial<DocumentData<T>>, newData: DocumentData<T>, options?: SimpleQueryReplaceByExampleOptions): Promise<ArangoResponseMetadata & SimpleQueryReplaceByExampleResult>;
    /**
     ...
     * ```
     */
    updateByExample(example: Partial<DocumentData<T>>, newData: Patch<DocumentData<T>>, options?: SimpleQueryUpdateByExampleOptions): Promise<ArangoResponseMetadata & SimpleQueryUpdateByExampleResult>;
    /**
 ...
 * ```
 */
export interface EdgeCollection<T extends object = any> extends DocumentCollection<T> {
    /**
     * Retrieves the document matching the given key or id.
     *
     * Throws an exception when passed a document or `_id` from a different
     ...
     * ```
     */
    save(data: EdgeData<T>, options?: CollectionInsertOptions): Promise<DocumentMetadata & {
        new?: Edge<T>;
    }>;
    /**
     * Inserts new documents with the given `data` into the collection.
     ...
     * ```
     */
    saveAll(data: Array<EdgeData<T>>, options?: CollectionInsertOptions): Promise<Array<DocumentMetadata & {
        new?: Edge<T>;
    }>>;
    /**
     * Replaces an existing document in the collection.
 ...
 * @hidden
 */
export declare class Collection<T extends object = any> implements EdgeCollection<T>, DocumentCollection<T> {
    ...
    protected _get<T extends {}>(path: string, qs?: any): Promise<ArangoResponseMetadata & T>;
    protected _put<T extends {}>(path: string, body?: any): Promise<ArangoResponseMetadata & T>;
    ...
    replaceByExample(example: Partial<DocumentData<T>>, newData: DocumentData<T>, options?: SimpleQueryReplaceByExampleOptions): Promise<any>;
    updateByExample(example: Partial<DocumentData<T>>, newData: Patch<DocumentData<T>>, options?: SimpleQueryUpdateByExampleOptions): Promise<any>;
